...
// The "JamPad" title wordmark: each letter is built FROM musical notation — J = a stem with a
// bottom hook + note-head foot, a = a filled note-bowl on a stem, m = beamed stems (♫), P = a
// stem with a note-head bulge, d = a literal quarter note (♩). Wide aspect (660x170), rasterized
// separately from the square icons.
export const TITLE_SVG = `<svg width="660" height="170" viewBox="0 0 660 170" xmlns="http://www.w3.org/2000/svg"><g transform="translate(6,12)" fill="none" stroke="#3a2f22" stroke-width="7" stroke-linecap="round" stroke-linejoin="round"><g><line x1="62" y1="44" x2="120" y2="40" stroke="#e2574c" stroke-width="9"/><line x1="96" y1="42" x2="96" y2="112"/><path d="M96 112 C96 132 74 134 62 122"/><ellipse cx="60" cy="124" rx="16" ry="11" fill="#e2574c" stroke="none" transform="rotate(-20 60 124)"/></g><g><path d="M214 98 C214 78 190 74 180 88 C170 102 176 121 194 121 C210 121 214 110 214 98" fill="#3fb0ac" stroke-width="6"/><line x1="214" y1="82" x2="214" y2="128"/><ellipse cx="214" cy="130" rx="15" ry="10" fill="#3fb0ac" stroke="none" transform="rotate(-20 214 130)"/></g><g><line x1="276" y1="128" x2="276" y2="90"/><path d="M276 92 C276 77 296 77 300 92"/><line x1="300" y1="128" x2="300" y2="92"/><path d="M300 92 C300 77 320 77 324 92"/><line x1="324" y1="128" x2="324" y2="92"/><ellipse cx="276" cy="130" rx="12" ry="8.5" fill="#f2b705" stroke="none" transform="rotate(-20 276 130)"/><ellipse cx="324" cy="130" rx="12" ry="8.5" fill="#f2b705" stroke="none" transform="rotate(-20 324 130)"/></g><g><line x1="406" y1="134" x2="406" y2="44"/><path d="M406 48 C446 42 456 82 424 88 C414 90 408 86 406 80" fill="#6f42ab" stroke-width="6"/><ellipse cx="406" cy="136" rx="16" ry="11" fill="#6f42ab" stroke="none" transform="rotate(-20 406 136)"/></g><g><path d="M552 98 C552 78 528 74 518 88 C508 102 514 121 532 121 C548 121 552 110 552 98" fill="#ef8a3c" stroke-width="6"/><line x1="552" y1="82" x2="552" y2="128"/><ellipse cx="552" cy="130" rx="15" ry="10" fill="#ef8a3c" stroke="none" transform="rotate(-20 552 130)"/></g><g><ellipse cx="596" cy="116" rx="17" ry="12" fill="#5bb974" stroke="#3a2f22" stroke-width="5" transform="rotate(-18 596 116)"/><line x1="613" y1="114" x2="613" y2="44"/></g></g></svg>`;
