...
import { initAudio } from '../audio/jamEngine';
...
export class MainMenu extends Scene {
  ...
  create() {
    ...
    // The first tap is BOTH the "start" gesture and the audio-unlock gesture.
    // Web Audio stays suspended until resumed inside a user gesture (critical on mobile).
